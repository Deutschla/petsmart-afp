...
class Post_Grid extends Custom_Widget_Base {
	...
	public function __construct( $data = [], $args = null ){
		$this->rt_name = esc_html__( 'RT Post Grid', 'yakeen-core' );
	...
	public function rt_fields(){
		$fields = array(
			...
			array(
				...
				'options' => array(
					'style1' => esc_html__( 'Grid Layout 1', 'yakeen-core' ),
					'style2' => esc_html__( 'Grid Layout 2', 'yakeen-core' ),
					'style3' => esc_html__( 'Grid Layout 3', 'yakeen-core' ),
					'style4' => esc_html__( 'Grid Layout 4', 'yakeen-core' ),
					'style5' => esc_html__( 'Grid Layout 5', 'yakeen-core' ),
					'style6' => esc_html__( 'Grid Layout 6', 'yakeen-core' ),
					'style7' => esc_html__( 'Grid Layout 7', 'yakeen-core' ),
					'style8' => esc_html__( 'Grid Layout 8', 'yakeen-core' ),
				),
				'default' => 'style1',
			),
			array(
			...
			array(
				...
				'condition'   => array( 'style' => array( 'style1', 'style2', 'style4', 'style5', 'style6',  'style7' ) ),
			),
			array(
				'type'    => Controls_Manager::SELECT2,
				'id'      => 'cat_layout',
			...
			array(
				...
				'mode' 			=> 'responsive',
				'id'      => 'itemspace',
				'label'   => esc_html__( 'Item Spacing', 'yakeen-core' ),
				'size_units' => array( 'px', '%' ),
				'default' => array(
					'unit' => 'px',
					'size' => '',
			...
			array(
				...
				'selectors' => array(
					'{{WRAPPER}} .rt-post-grid-style3 .rt-item .rt-image' => 'margin-right: {{SIZE}}{{UNIT}};',
					'{{WRAPPER}} .rt-post-grid-style5 .rt-item .rt-image' => 'margin-right: {{SIZE}}{{UNIT}};',
					'{{WRAPPER}} .rt-post-grid-style6 .rt-item .rt-image' => 'margin-right: {{SIZE}}{{UNIT}};',
				),
			...
			array(
				...
				'condition'   => array( 'content_display' => array( 'yes' ), 'style' => array( 'style1', 'style2', 'style4', 'style5', 'style6',  'style7' ) ),
			),
			array(
				'type'    => Controls_Manager::NUMBER,
				'id'      => 'count',
			...
			array(
				'type'        => Controls_Manager::SWITCHER,
				'id'          => 'post_image',
				'label'       => esc_html__( 'Show Image', 'yakeen-core' ),
				'label_on'    => esc_html__( 'Show', 'yakeen-core' ),
				'label_off'   => esc_html__( 'Hide', 'yakeen-core' ),
				'default'     => 'yes',
			...
			array(
				...
				'selectors' => array(
					...
					'{{WRAPPER}} .rt-post-grid-default ul.entry-meta li svg path' => 'stroke: {{VALUE}}',
				),
			),
			array(
	            'type'    => Controls_Manager::DIMENSIONS,
	        ...
	        array (
				...
				'selector' => '{{WRAPPER}} .rt-post-grid-default .rt-item .entry-categories .category-style',
				'selector' => '{{WRAPPER}} .rt-post-grid-default .rt-item .entry-categories .post-categories li a',
			),
			array(
				'type'    => Controls_Manager::COLOR,
				'id'      => 'cat_color',
				...
				'default' => '',
				'selectors' => array(
					'{{WRAPPER}} .rt-post-grid-default .rt-item .entry-categories a' => 'color: {{VALUE}}',
					'{{WRAPPER}} .rt-post-grid-default .rt-item .entry-categories ul li:before' => 'background-color: {{VALUE}}',
				),
			),
			array(
				'type'    => Controls_Manager::COLOR,
				...
				'default' => '',
				'selectors' => array(
					'{{WRAPPER}} .rt-post-grid-default .rt-item .entry-categories a:hover' => 'color: {{VALUE}}',
					'{{WRAPPER}} .rt-post-grid-default .rt-item .entry-categories ul li a:hover' => 'color: {{VALUE}}',
				),
			),
			array(
	            'type'    => Controls_Manager::DIMENSIONS,
	            ...
	            'label'   => __( 'Margin', 'yakeen-core' ),                 
	            'selectors' => array(
	                '{{WRAPPER}} .rt-post-grid-default .rt-item .entry-categories' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}} !important;',                    
	            ),
	            'separator' => 'before',
	        ),
	        array(
	        ...
	        array(
	            ...
	            'selectors' => array(
	                '{{WRAPPER}} .rt-post-grid-default .rt-item .rt-image' => 'max-width: {{SIZE}}{{UNIT}} !important;',                    
	            ),
	            'separator' => 'before',
	        ),
			array(
			...
			array(
				...
				'selectors' => array(
					'{{WRAPPER}} .rt-post-grid-default .rt-single-item .rt-image img' => 'min-height: {{SIZE}}{{UNIT}};',
				),
			),
	        array(
				'mode' => 'section_end',
			...
			array(
				...
				'condition'   => array( 'style' => array( 'style1', 'style2', 'style3', 'style5', 'style6', 'style7', 'style8' ) ),
			),
			array(
				'type'    => Controls_Manager::SELECT2,
				'id'      => 'col_xl',
	...
	protected function render() {
		...
		switch ( $data['style'] ) {
			case 'style8':
			$template = 'post-grid-8';
			break;
			case 'style7':
			$template = 'post-grid-7';
			break;
			case 'style6':
