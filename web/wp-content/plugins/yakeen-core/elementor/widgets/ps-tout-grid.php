...
class PS_Tout_Grid extends Custom_Widget_Base {

	public function __construct( $data = [], $args = null ){
		$this->rt_name = esc_html__( 'PS Tout Grid', 'yakeen-core' );
		$this->rt_base = 'ps-tout-grid';
