...
class Post_Overlay extends Custom_Widget_Base {
	...
	public function __construct( $data = [], $args = null ){
		$this->rt_name = esc_html__( 'RT Post Overlay', 'yakeen-core' );
		$this->rt_base = 'rt-post-overlay';
	...
	public function rt_fields(){
		$fields = array(
			...
			array(
				...
				'default' => '',
				'selectors' => array(
					'{{WRAPPER}} .rt-item .entry-content .entry-categories' => 'width: 100%; {{VALUE}};',
					'{{WRAPPER}} .rt-item .entry-content .entry-title' => '{{VALUE}};',
					'{{WRAPPER}} .rt-item .entry-content .entry-meta' => '{{VALUE}};',
					'{{WRAPPER}} .rt-item .entry-content .post_excerpt' => '{{VALUE}};',
					'{{WRAPPER}} .rt-item .entry-content .post-read-more' => '{{VALUE}};',
				),
			),
			array(
				...
				'options' => array(
					'style1' => esc_html__( 'Overlay Layout 1', 'yakeen-core' ),
					'style2' => esc_html__( 'Overlay Layout 2', 'yakeen-core' ),
					'style3' => esc_html__( 'Overlay Layout 3', 'yakeen-core' ),
					'style4' => esc_html__( 'Overlay Layout 4', 'yakeen-core' ),
					'style5' => esc_html__( 'Overlay Layout 5', 'yakeen-core' ),
					'style6' => esc_html__( 'Overlay Layout 6', 'yakeen-core' ),
					'style7' => esc_html__( 'Overlay Layout 7', 'yakeen-core' ),
					'style8' => esc_html__( 'Overlay Layout 8', 'yakeen-core' ),
					'style9' => esc_html__( 'Overlay Layout 9', 'yakeen-core' ),
					'style10' => esc_html__( 'Overlay Layout 10', 'yakeen-core' ),
					'style11' => esc_html__( 'Overlay Layout 11', 'yakeen-core' ),
					'style12' => esc_html__( 'Overlay Layout 12', 'yakeen-core' ),
				),
				'default' => 'style1',
			),
			/*Post Order*/
			...
			array(
				...
				'default' => 10,
				'description' => esc_html__( 'Maximum number of title', 'yakeen-core' ),
				'condition'   => array( 'style' => array( 'style6', 'style7', 'style8', 'style10' ) ),
			),
			array(
				'type' 			=> Controls_Manager::SLIDER,
				'mode' 			=> 'responsive',
				...
				'selectors' => array(
					'{{WRAPPER}} .rt-item:not(.rt-multi-items) .entry-content .entry-title' => 'width: {{SIZE}}{{UNIT}};',
				),
			),
			array(
				'type' 			=> Controls_Manager::SLIDER,
				'mode' 			=> 'responsive',
				'id'      		=> 'small_title_width',
				'label'   		=> esc_html__( 'Small Title Width', 'yakeen-core' ),						
				'size_units' => array( 'px', '%', 'em' ),
				'default' => array(
				'unit' => '%',
				'size' => '',
				...
				'selectors' => array(
					'{{WRAPPER}} .rt-item.rt-multi-items .entry-content .entry-title' => 'width: {{SIZE}}{{UNIT}};',
				),
				'condition'   => array( 'style' => array( 'style6', 'style7', 'style8', 'style10' ) ),
			),
			array (
				...
				'default'     => 'yes',
				'condition'   => array( 'style' => array( 'style1','style2', 'style3','style4', 'style6', 'style7', 'style8', 'style10', 'style11', 'style12' ) ),
			),
			array(
				'type' 			=> Controls_Manager::SLIDER,
				'mode' 			=> 'responsive',
				...
				'condition'   => array( 'content_display' => array( 'yes' ), 'style' => array( 'style1','style2', 'style3','style4', 'style6', 'style7', 'style8', 'style10', 'style11', 'style12' ) ),
			),
			array(
				'type'    => Controls_Manager::NUMBER,
				'id'      => 'count',
			...
			array(
				...
				'label_off'   => esc_html__( 'Hide', 'yakeen-core' ),
				'default'     => 'yes',
				'condition'   => array( 'style' => array( 'style1','style2', 'style3','style4', 'style5', 'style6', 'style7', 'style9', 'style11', 'style12' ) ),
			),
			array(
				'type'        => Controls_Manager::SWITCHER,
	        ...
	        array (
				...
				'selector' => '{{WRAPPER}} .rt-post-overlay-default .rt-item .entry-title',
			),
			array (
				'mode'    => 'group',
				'type'    => Group_Control_Typography::get_type(),
				...
				'selector' => '{{WRAPPER}} .rt-post-overlay-default .rt-multi-items .entry-title',
				'condition'   => array( 'style' => array( 'style6', 'style7', 'style8', 'style10' ) ),
			),
			array(
				...
				'default' => '',
				'selectors' => array(
					'{{WRAPPER}} .rt-post-overlay-default .rt-single-item .entry-title a' => 'color: {{VALUE}}',
				),
			),
			array(
				'type'    => Controls_Manager::COLOR,
				'id'      => 'small_title_color',
				'label'   => esc_html__( 'Small Title Color', 'yakeen-core' ),
				'default' => '',
				'selectors' => array(
					'{{WRAPPER}} .rt-post-overlay-default .rt-multi-items .entry-title a' => 'color: {{VALUE}}',
				),
				'condition'   => array( 'style' => array( 'style6', 'style7', 'style8', 'style10' ) ),
			),
			array(
	            ...
	            'selectors' => array(
	                '{{WRAPPER}} .rt-post-overlay-default .rt-item .entry-title' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}} !important;',                    
	            ),
	            'separator' => 'before',
	        ),
			array(
	        ...
	        array (
				...
				'selector' => '{{WRAPPER}} .rt-post-overlay-default ul.entry-meta li',
			),
			array(
				'type'    => Controls_Manager::COLOR,
				'id'      => 'meta_color',
				...
				'default' => '',
				'selectors' => array(
					'{{WRAPPER}} .rt-post-overlay-default .rt-single-item ul.entry-meta li' => 'color: {{VALUE}}',
					'{{WRAPPER}} .rt-post-overlay-default .rt-single-item ul.entry-meta li a' => 'color: {{VALUE}}',
				),
			),
			array(
				'type'    => Controls_Manager::COLOR,
				...
				'default' => '',
				'selectors' => array(
					'{{WRAPPER}} .rt-post-overlay-default .rt-single-item ul.entry-meta li i' => 'color: {{VALUE}}',
					'{{WRAPPER}} .rt-post-overlay-default .rt-single-item ul.entry-meta li svg path' => 'stroke: {{VALUE}}',
				),
			),
			array(
				'type'    => Controls_Manager::COLOR,
				...
				'default' => '',
				'selectors' => array(
					'{{WRAPPER}} .rt-post-overlay-default .rt-single-item ul.entry-meta .post-author a' => 'color: {{VALUE}}',
				),
			),
			array(
				'type'    => Controls_Manager::COLOR,
				'id'      => 'small_meta_color',
				'label'   => esc_html__( 'Small Meta Color', 'yakeen-core' ),
				'default' => '',
				'selectors' => array(
					'{{WRAPPER}} .rt-post-overlay-default .rt-multi-items ul.entry-meta li' => 'color: {{VALUE}}',
					'{{WRAPPER}} .rt-post-overlay-default .rt-multi-items ul.entry-meta li a' => 'color: {{VALUE}}',
					'{{WRAPPER}} .rt-post-overlay-default .rt-multi-items .post-terms a' => 'color: {{VALUE}}',
				),
				'condition'   => array( 'style' => array( 'style6', 'style7', 'style8', 'style10' ) ),
			),
			array(
				...
				'label'   => esc_html__( 'Small Meta Icon Color', 'yakeen-core' ),
				'default' => '',
				'selectors' => array(
					'{{WRAPPER}} .rt-post-overlay-default .rt-multi-items ul.entry-meta li i' => 'color: {{VALUE}}',
					'{{WRAPPER}} .rt-post-overlay-default .rt-multi-items ul.entry-meta li svg path' => 'stroke: {{VALUE}}',
				),
				'condition'   => array( 'style' => array( 'style6', 'style7', 'style8', 'style10' ) ),
			),
			array(
				...
				'label'   => esc_html__( 'Small Meta Author Color', 'yakeen-core' ),
				'default' => '',
				'selectors' => array(
					'{{WRAPPER}} .rt-post-overlay-default .rt-multi-items ul.entry-meta .post-author a' => 'color: {{VALUE}}',
				),
				'condition'   => array( 'style' => array( 'style6', 'style7', 'style8', 'style10' ) ),
			),
			array(
	            ...
	            'label'   => __( 'Margin', 'yakeen-core' ),                 
	            'selectors' => array(
	                '{{WRAPPER}} .rt-post-overlay-default ul.entry-meta' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}} !important;',                    
	            ),
	            'separator' => 'before',
	        ),
	        array(
	        ...
	        array (
				...
				'selector' => '{{WRAPPER}} .rt-post-overlay-default .rt-item .entry-categories .category-style',
				'selector' => '{{WRAPPER}} .rt-post-overlay-default .rt-item .entry-categories .post-categories li a',
			),
			array(
				'type'    => Controls_Manager::COLOR,
				'id'      => 'cat_color',
				...
				'default' => '',
				'selectors' => array(
					'{{WRAPPER}} .rt-post-overlay-default .rt-item .entry-categories a' => 'color: {{VALUE}}',
					'{{WRAPPER}} .rt-post-overlay-default .rt-item .entry-categories ul li:before' => 'background-color: {{VALUE}}',
				),
			),
			array(
				'type'    => Controls_Manager::COLOR,
				...
				'default' => '',
				'selectors' => array(
					'{{WRAPPER}} .rt-post-overlay-default .rt-item .entry-categories a:hover' => 'color: {{VALUE}}',
					'{{WRAPPER}} .rt-post-overlay-default .rt-item .entry-categories ul li a:hover' => 'color: {{VALUE}}',
				),
			),
			array(
	            'type'    => Controls_Manager::DIMENSIONS,
	            ...
	            'label'   => __( 'Margin', 'yakeen-core' ),                 
	            'selectors' => array(
	                '{{WRAPPER}} .rt-post-overlay-default .rt-item .entry-categories' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}} !important;',                    
	            ),
	            'separator' => 'before',
	        ),
	        array(
			...
			array(
				...
				'selectors' => array(
					'{{WRAPPER}} .rt-post-overlay-default .rt-item .rt-image img' => 'width: {{SIZE}}{{UNIT}};',
				),
			),
			array(
				'type'    => Controls_Manager::SLIDER,
				...
				'selectors' => array(
					'{{WRAPPER}} .rt-post-overlay-default .rt-single-item .rt-image img' => 'min-height: {{SIZE}}{{UNIT}};',
				),
			),
	        array(
				'mode' => 'section_end',
			...
			array(
				...
				'condition'   => array( 'style' => array( 'style1', 'style2', 'style3', 'style4', 'style5', 'style9', 'style11', 'style12' ) ),
			),			
			array(
				'type'    => Controls_Manager::SELECT2,
				'id'      => 'col_xl',
