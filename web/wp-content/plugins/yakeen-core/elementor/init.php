...
class Custom_Widget_Init {
	...
	public function after_enqueue_styles_elementor_editor()	{
		wp_enqueue_style( 'flaticon', \YakeenTheme_Helper::get_font_css( 'flaticon' ) );		
	}
	...
	public function custom_icon_for_elementor( $controls_registry )
	{
		...
		// Append new icons		
		$flaticons = YakeenTheme_Helper::get_flaticon_icons();
	...
	public function additional_tabs($tabs)
      {
        $json_url = YakeenTheme_Helper::get_asset_file('json/flaticon.json');

        $flaticon = [
          'name'          => 'flaticon',
          'label'         => esc_html__( 'Yakeen Icon', 'yakeen-core' ),
          'url'           => false,
          'enqueue'       => false,
          'prefix'        => '',
          'displayPrefix' => '',
  ...
  function add_elementor_section_background_controls( \Elementor\Element_Section $section ) {
		...
		$section->add_control(
			'rt_section_parallax',
			[
				'label' => __( 'Parallax', 'yakeen-core' ),
				'type' => \Elementor\Controls_Manager::SWITCHER,
				'label_off' => __( 'Off', 'yakeen-core' ),
				'label_on' => __( 'On', 'yakeen-core' ),
				'default' => 'no',
		...
		$section->add_control(
			...
			[
				'label' => __( 'Parallax Transition off?', 'yakeen-core' ),
				'type' => \Elementor\Controls_Manager::SWITCHER,
				'label_off' => __( 'on', 'yakeen-core' ),
				'label_on' => __( 'Off', 'yakeen-core' ),
				'default' => 'off',
				'return_value' => 'off',
