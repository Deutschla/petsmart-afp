...
<div class="rt-thumb-slider-horizontal rt-swiper-horizontal-slider">
    <div class="swiper-container horizontal-slider" data-xld ="<?php echo esc_attr( $data['swiper_data'] );?>">
        ...
        <?php
            ...
            <div class="swiper-slide">
                <div class="rt-item rt-slide-main rt-single-item">                       
                    <div class="entry-content">
                        <div class="inner-content">
                            <?php if ( $data['post_category'] == 'yes' ) { ?>
                                ...
                                <?php } ?>
                            <?php } ?>	
                            <h2 class="entry-title title-size-xl title-animation-underline size-2"><a href="<?php the_permalink();?>"><?php echo esc_html( $title );?></a></h2>
                            ...
                            <?php if ( $data['post_read'] == 'yes' ) { ?>
                                <div class="post-read-more">
                                    <a class="button-style-1 mt-2 mb-3 rt-animation-out" href="<?php the_permalink();?>"><?php esc_html_e( 'Continue Reading ', 'yakeen' );?><?php echo yakeen_btn_arrow(); ?></a>
                                </div>
                            <?php } ?>
                        </div>
                    </div>
                            ...
                            <?php
                                if ( has_post_thumbnail() ){
                                    ...
                                    if ( !empty( YakeenTheme::$options['no_preview_image']['id'] ) ) {
                                        ...
                                        echo '<img class="wp-post-image" src="' . YakeenTheme_Helper::get_img( 'noimage_956X828.jpg' ) . '" alt="'.get_the_title().'">';
                                    }
                                }
                            ?>
                        </a>
                    ...
                    <div class="rt-item rt-slide-thumb"> 
                        ...
                        <div class="entry-content">                     
                            <?php if ( $data['small_post_category'] == 'yes' ) { ?>
                                ...
                                <?php } ?>
                            <?php } ?>	
                            <h3 class="entry-title no-hover"><a href="javascript:void(0)"><?php echo esc_html( $small_title );?></a></h3>
