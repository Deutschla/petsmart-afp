...
$thumb_size1 = 'yakeen-size7';
$thumb_size2 = 'yakeen-size7';
									...
									<?php
										if ( has_post_thumbnail() ){
											...
											if ( !empty( YakeenTheme::$options['no_preview_image']['id'] ) ) {
												...
												echo '<img class="wp-post-image" src="' . YakeenTheme_Helper::get_img( 'noimage_732X440.jpg' ) . '" alt="'.get_the_title().'">';
											}
										}
									?>
								</a>										
			...
			<?php } ?>
				...
				<?php if ( $count > 1 ) { ?>
					<div class="col-12 <?php echo esc_attr( $data['animation'] );?> <?php echo esc_attr( $data['animation_effect'] );?>" data-wow-delay="<?php echo esc_attr( $i );?>s" data-wow-duration="<?php echo esc_attr( $j );?>s">
						<div class="rt-item rt-mask-content rt-multi-items">
                            <div class="rt-image">
                                <a href="<?php the_permalink(); ?>">
                                    <?php
                                        if ( has_post_thumbnail() ){
                            ...
                            <div class="entry-content">
                                <h3 class="entry-title title-animation-underline size-2"><a href="<?php the_permalink();?>"><?php echo esc_html( $small_title );?></a></h3>
