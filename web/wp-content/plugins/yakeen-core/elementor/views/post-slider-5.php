		...
		<div class="swiper-wrapper">
			...
			<?php while ( $query->have_posts() ) : $query->the_post();?>
				...
				<div class="swiper-slide">
					<div class="rt-item rt-mask-content rt-single-item <?php echo esc_attr( $data['animation'] );?> <?php echo esc_attr( $data['animation_effect'] );?>" data-wow-delay="<?php echo esc_attr( $i );?>s" data-wow-duration="<?php echo esc_attr( $j );?>s">					
						<div class="rt-image">
								...
								<?php
									if ( has_post_thumbnail() ){
										...
										if ( !empty( YakeenTheme::$options['no_preview_image']['id'] ) ) {
											...
											echo '<img class="wp-post-image" src="' . YakeenTheme_Helper::get_img( 'noimage_1110X650.jpg' ) . '" alt="'.get_the_title().'">';
										}
									}
								?>
							</a>										
