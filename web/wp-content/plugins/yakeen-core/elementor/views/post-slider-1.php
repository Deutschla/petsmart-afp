			...
			<?php $i = $data['delay']; $j = $data['duration'];
				if ( $query->have_posts() ) :?>
					...
					<div class="swiper-slide">
						<div class="rt-item rt-single-item <?php echo esc_attr( $data['animation'] );?> <?php echo esc_attr( $data['animation_effect'] );?>" data-wow-delay="<?php echo esc_attr( $i );?>s" data-wow-duration="<?php echo esc_attr( $j );?>s">
							<div class="rt-image">
