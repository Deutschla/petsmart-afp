...
?>
<div class="rt-post-list-default number-counter rt-post-list-<?php echo esc_attr( $data['style'] );?>">
				...
				<div class="rt-item rt-single-item">
					<div class="rt-image">
						<?php if ( ( $data['post_video'] == 'yes' && 'video' == get_post_format( $id ) && !empty( $youtube_link ) ) ) { ?>
							<a class="rt-play play-btn-md btn-position-center rt-video-popup" href="<?php echo esc_url( $youtube_link );?>"><i class="fas fa-play"></i></a>
						<?php } ?>
