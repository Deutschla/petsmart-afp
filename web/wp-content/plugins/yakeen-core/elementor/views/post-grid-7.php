				...
				<div class="rt-item rt-single-item">
					<div class="rt-image">
						...
						<a href="<?php the_permalink(); ?>">
							<?php
								if ( has_post_thumbnail() ){
									the_post_thumbnail( ('yakeen-size' . rand( 3, 5 ) ) );
								}
								else {
									if ( !empty( YakeenTheme::$options['no_preview_image']['id'] ) ) {
										echo wp_get_attachment_image( YakeenTheme::$options['no_preview_image']['id'], ('yakeen-size' . rand( 3, 5 ) ) );
									}
									else {
						...
						<?php if ( $data['post_date'] == 'yes' ) { ?>	
							<div class="post-date style-1"><?php echo $yakeen_time_html; ?></div>				
						<?php } ?>						
					</div>
