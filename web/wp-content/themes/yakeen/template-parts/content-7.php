...
if (  YakeenTheme::$layout == 'right-sidebar' || YakeenTheme::$layout == 'left-sidebar' ){
	$post_classes = array( 'col-xl-4 col-lg-6 col-md-4 col-sm-6 col-12 rt-grid-item blog-layout-7 ' . $wow . ' ' . $effect );
	$ul_class = 'side_bar';
} else {
	$post_classes = array( 'col-xl-3 col-lg-4 col-sm-6 col-12 mx-auto rt-grid-item blog-layout-7 ' . $wow . ' ' . $effect );
	$ul_class = '';
}
