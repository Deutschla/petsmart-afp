...
if( ! function_exists( 'yakeen_breadcrumbs' )){

	function yakeen_breadcrumbs(){

		# breadcrumbs ----------
		
		$delimiter  = ' <i class="fas fa-caret-right"></i> ';
		$delimiter  = '<em class="delimiter">'. $delimiter .'</em>';

		$home_text  = esc_html__( 'Home', 'yakeen' );
		...
		if ( ! is_home() && ! is_front_page() || is_paged() ){
			...
			elseif ( is_singular() ){			
				...
				if ( get_post_type() == 'post' ){
					...
					$category = yakeen_get_primary_category_id();
					$category = get_category( $category );
