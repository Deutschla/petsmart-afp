...
if ( class_exists( 'WP_Customize_Control' ) ) {
    ...
    /* Header Animate Image Enabled */
    if (!function_exists('rttheme_is_header_image_enabled')) {
        function rttheme_is_header_image_enabled()
        {
            $header_animated_enabled = get_theme_mod('header_animated_enabled');
            if (empty($header_animated_enabled)) {
                return false;
            }
            return true;
        }
    ...
    /* Search is enabled */
    if (!function_exists('rttheme_is_searchbox_enabled')) {
        function rttheme_is_searchbox_enabled()
        {
